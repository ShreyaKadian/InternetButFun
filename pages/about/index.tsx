...
export default function DocsPage() {
  return (
    <DefaultLayout>
      <section className="flex flex-col   md:py-10 ">
        ...
        <p className="text-black text-2xl mt-12 ">You go on the Instgram to message a friend...you are drawn into reels. <br></br><br></br>  You go on twitter to get the news...
        you see the most insufferable people fighting about poltics <br></br><br></br> You try reddit...yaah I dont think I have to say smthn about reddit <br></br> <br></br> Youtube
        used to be fun...now its all stupid bs designed to keep u watching for as long as possible (oh and also steal all your data  ❤️) <br></br><br></br>  Now dont get
        me wrong social media isnt all bad or anything but no one can deny the goal of these companies is not to provide a platform that connects or entertains
        ...
        better ads  ❤️). <br></br><br></br>  And the worst part is to do this they use every tactic possible doesnt matter how harmful or evil it is. They play on people's emotions
        ...
        <br></br> <br></br> The newer apps like tiktok are designed to addict people...people my age spend like 8-9 hours on social media daily which like do with your 
  ...
  <li> News tab with specially cured news to make u laugh or just say W
  </li>
    ...
    <li>Global chat room just to hang out smthn thats missing from every website atp</li>
        <li>Super personalised profile page insead of the generic ones we get today. Tell us your mood, your 5 favourite things , your favourite songs , your
          interest and anything else u want....not as customisable as myspace but we will get there </li>
                        ...
                        <p className="text-black text-2xl mt-8"> We are still a work in progress and any sort of support is highly appreciated as the website is
                          coded by one stupid developer only (me)
                        Feel free to mail for any queries-<br></br>internetbutfun@gmail.com <br></br>shreyakadian124@gmail.com</p>
